...
import { About, About2, Academics, Admissions, CampusLife, ResearchInnovation, Placements, Programs } from "../Json/MenuItem";
...
export default function NewNavBar() {
    ...
    const LinksList = ({ title, links, titleClassName, ulClassName, setBigMenuToggle }) => (
        <div className="w-fit max-lg:mb-5 lg:mr-10 max-md:w-full">
            {title && (
                <h3 className={`font-novaBold text-base text-blue-900 leading-none mb-3 ${titleClassName}`}>{title}</h3>
            )}
            ...
            <div className="mt-3 px-3">
                ...
                >
                    ...
                    <li className="group">
                        ...
                        <div
                            className={`${
                                BigMenuToggle ? "relative w-full bg-white/40" : "absolute w-[1100px]"
                    ...
                    <li className="group">
                        ...
                        <div
                            className={`${
                                BigMenuToggle ? "relative w-full bg-white/40" : "absolute w-[650px]"
                    ...
                    <li className="group">
                        ...
                        <div
                            className={`${
                                BigMenuToggle ? "relative w-full bg-white/40" : "absolute w-[1050px]"
                                    ...
                                    <div className={`flex ${BigMenuToggle && "flex-col gap-y-5"}`}>
                                        ...
                                        <div className={`w-52 pr-2 ${BigMenuToggle && "w-full"}`}>
                                            <LinksList
                                                ...
                                                links={
                                                    ResearchInnovation.sublinks[`Sustainable Development Goals (SDG's)`]
                                                }
                                                setBigMenuToggle={setBigMenuToggle}
                                            />
                                        </div>
