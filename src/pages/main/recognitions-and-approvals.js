...
const RecognitionApprovals = ({data}) => {
            ...
            <div className="bg-BG17 h-[450px] w-full top-20 bg-no-repeat bg-cover">
                <div className="max-w-[1400px] mx-auto h-full px-3">
                    <div className="max-w-2xl">
                        <div className="Cutout py-1 bg-yellow-400 mb-10">
                            <h2 className="text-4xl font-novaReg">NAAC A++ Rating</h2>
                        </div>
                        <p className="font-novaReg text-lg leading-6">
                            AKG University is a fully established institution under the UP State Legislature and is
                            recognized by the University Grants Commission (UGC) under Section 2(f) of the UGC Act,
                            1956. The university holds the prestigious NAAC A++ accreditation, placing it among the top
                ...
                <div className="max-w-[1400px] mx-auto py-12 px-3">
                    <div className="grid grid-cols-1 w-full gap-3 md:grid-cols-7">
                        ...
                        <div className="px-3 col-span-1 md:col-span-2">
                            <h3 className="text-2xl font-novaReg mb-6">Click below to view other Recognitions</h3>
                            <div className="flex flex-col">
                                {recognitionsData.map((item) => (
                                    <React.Fragment key={item.id}>
                                        ...
                                        >
                                            <div
                                                className={`flex flex-row mb-10 p-5 items-center ${
                            ...
                            <div className="p-11 shadow-[rgba(13,_38,_76,_0.19)_0px_0px_10px]">
                                <div className="flex mb-12 -mx-3">
                                    <div className="px-3">
                                        ...
                                        <p className="text-lg font-novaReg mt-2.5 mb-5">{selectedDescription}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 mt-4 w-full bg-red-600 md:grid-cols-7">
                                <div className="col-span-3 md:col-span-1">
                                    <img src="/image/top-nav.jpg" className="w-full" alt="Top Navigation" />
                                </div>
    ...
    <div className="bg-gradient-to-r from-slate-700 via-blue-800 to-indigo-900 text-white text-lg md:text-xl font-semibold py-4 px-6 rounded-2xl shadow-lg inline-block max-w-4xl">
        These accreditations and approvals reflect our supreme standing in technical and professional education.
    </div>
</div>
